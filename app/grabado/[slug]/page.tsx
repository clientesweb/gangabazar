...
import { GrabadoDetailClient } from "./grabado-client"

export default async function GrabadoPage({ params }: { params: Promise<{ slug: string }> }) {
      ...
      <div className="min-h-screen">
        ...
        <main className="flex min-h-[60vh] items-center justify-center">
          <div className="text-center">
            ...
            <a href="/colecciones/grabados" className="mt-4 inline-block text-sm text-muted-foreground hover:text-accent">
              Volver a Grabados
            </a>
          </div>
        </main>
