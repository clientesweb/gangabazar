...
import { ProductDetailClient } from "@/app/producto/[slug]/product-client"

export default async function AccesorioProductPage({ params }: { params: Promise<{ slug: string }> }) {
      ...
      <div className="min-h-screen">
        ...
        <main className="flex min-h-[60vh] items-center justify-center">
          <div className="text-center">
            ...
            <a href="/categorias/accesorios" className="mt-4 inline-block text-sm text-muted-foreground hover:text-accent">
              Volver a Accesorios
            </a>
          </div>
        </main>
